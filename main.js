...
/* ================= CONFIG NO-FECHAS (rango de grupos, storage) ================= */
var YEAR1_RANGE = { min: 1101, max: 1182 };
var YEAR2_RANGE = { min: 2201, max: 2265 };

var STORAGE_KEY   = "deptScheduler.state.v6_remote";
var SNAPSHOT_KEY  = (year)=>`deptScheduler.snapshot.year${year}`;

/* =============== Estado global UI =============== */
var currentGroupId = null;
var currentYear    = 1;
var showSubjectWeeks = false;
...
var examIdToObj = {};
var subjectChains = {1:{},2:{}};
var examLabelIndex = {1:{},2:{}};
